...
func (c *ConnAnd) ContextF(ctx context.Context) {
	c.context = ctx
}
func (c *ConnAnd) Where(f string, v *EsFields) error {
	t := Term{f, v.getData()}
	q, e := t.GetSourceMap()
	if e == nil {
...
func (c *ConnAnd) NotWhere(f string, v *EsFields) error {
	t := Term{f, v}
	q, e := t.GetSourceMap()
	if e == nil {
		qNew := map[string]map[string][]interface{}{
...
func (c *ConnAnd) WhereIn(f string, v *EsFields) error {
...
func (c *ConnAnd) NotWhereIn(f string, v *EsFields) error {
	t := Terms{f, v.getArrayData()}
	q, e := t.GetSourceMap()
	if e == nil {
		qNew := map[string]map[string][]interface{}{
